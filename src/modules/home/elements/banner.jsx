...
const Banner = () => {
  const { isSignedIn } = useUser(); // Clerk authentication hook
  ...
  return (
    <div className="bg-[#f7f5ff] h-[95vh] relative">
      {/* Decorative SVG */}
      <svg
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute text-center">
          ...
          <h3 className="text-3xl mt-4">Built for newsletter people</h3>
          ...
          <div className="flex w-full justify-center mt-6">
            <Button
              ...
              onClick={handleGetStarted} // Handle Click Event
            >
              Get Started
            </Button>
          </div>

          <h5 className="text-lg mt-2">Start a 30-day free trial</h5>
        </div>
      </div>
    </div>
  );
